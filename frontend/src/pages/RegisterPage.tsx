      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-primary-600 to-primary-900 p-12 flex-col justify-between">
        ...
        >
          <h1 className="text-4xl font-bold text-white leading-tight">
            Start Your Journey to Viral Success
          </h1>
          <p className="text-xl text-primary-100">
            Join content creators analyzing and replicating viral patterns
          </p>

          <div className="space-y-4 pt-8">
            <div className="flex items-center space-x-3">
              <div className="w-2 h-2 bg-white rounded-full" />
              <span className="text-primary-50">Unlimited viral content analysis</span>
            </div>
            <div className="flex items-center space-x-3">
              <div className="w-2 h-2 bg-white rounded-full" />
              <span className="text-primary-50">Voice note insights & strategy</span>
            </div>
            <div className="flex items-center space-x-3">
              <div className="w-2 h-2 bg-white rounded-full" />
              <span className="text-primary-50">Track emotions & outcomes</span>
            </div>
          </div>
        </motion.div>
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        ...
        >
          <div className="text-center mb-8">
            ...
            <p className="mt-2 text-gray-600">Start analyzing viral content today</p>
          </div>
